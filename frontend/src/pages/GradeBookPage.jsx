...
const GradeBookPage = ({ studyPlanId }) => {
  ...
  const letterGrade =
    overallGrade !== null ? getLetterGrade(overallGrade) : null;
  const hasWeights =
    entries.length > 0 &&
    entries.every((e) => e.weight !== null && e.weight !== undefined);

  if (loading)
    return <p className="gradebook-loading">Loading grade book...</p>;
    ...
    <div className="gradebook-container">
        ...
        <div>
          ...
          {overallGrade !== null ? (
            <div className="gradebook-banner-score">
              <span className="gradebook-overall-percent">
                {overallGrade.toFixed(2)}%
              </span>
              <span
                className="gradebook-overall-letter"
          ...
          <p className="gradebook-banner-meta">
            {hasWeights ? "Weighted average" : "Simple average"} ·{" "}
      ...
      {showForm && (
        <div className="gradebook-form-card">
          <p className="gradebook-form-title">
          ...
          <div className="gradebook-form-grid">
            ...
            <div>
              <label className="gradebook-label">
                Weight %{" "}
                <span className="gradebook-label-optional">(optional)</span>
              </label>
              <input
                className="gradebook-input"
                type="number"
          ...
          <div className="gradebook-form-actions">
            <button className="gradebook-cancel-btn" onClick={handleCancelForm}>
              Cancel
            </button>
      ...
      {entries.length === 0 ? (
        <div className="gradebook-empty">
          ...
          <p className="gradebook-empty-sub">
            ...
            return (
              <div key={entry._id} className="gradebook-entry-card">
                ...
                <div className="gradebook-entry-score">
                  <span className="gradebook-score-percent">
                    {entry.score}%
                  </span>
                  <span
                    className="gradebook-score-letter"
                ...
                <div className="gradebook-entry-actions">
                  <button
                    className="gradebook-edit-btn"
                    onClick={() => handleEdit(entry)}
                  >
                    Edit
                  </button>
                  <button
                    className="gradebook-delete-btn"
