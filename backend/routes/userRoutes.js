...
const {updateProfile, nameChange, deleteAccount, emailChange, toggle2FA, getNotificationSettings, updateNotificationSettings, getInfo, searchUsers } = require("../controllers/userController")
